...
def preflight(args: argparse.Namespace) -> dict[str, Any]:
    ...
    checks = {
        ...
        "serving_length_range_fully_covered": bool(
            observed_text_lengths
            and min(observed_text_lengths) == 3
            and max(observed_text_lengths) == WordmarkPriorConfig().max_characters
        ),
