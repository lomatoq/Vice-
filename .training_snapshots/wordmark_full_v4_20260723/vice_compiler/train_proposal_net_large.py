...
from .hard_negative_factory import (
    applicable_hard_negative_types, counterfactual_risk_regions,
)
...
from .proposal_data_contract import (
    RELATION_TYPES, TYPED_STRUCTURE_FAMILIES,
    relation_supervision, split_group as contract_split_group,
...
class PairDataset(Dataset):
    ...
    def __getitem__(self, index: int) -> dict:
        ...
        allowed_negative_types = applicable_hard_negative_types(
            row_families,
            jpeg=augmentation.get("jpeg_quality") is not None,
        ...
        if degraded:
            ...
            negative_type = (
                "preserve_jpeg_halo"
                if augmentation.get("jpeg_quality") is not None else
                "jagged_overfit"
        ...
        family_ids = []
        masks = []; boxes = []; topology = []; relations = []; relation_masks = []
