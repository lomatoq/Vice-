...
def _current_phase4_ablation_reports() -> tuple[str, str]:
    ...
    for path in directory.glob("*.json") if directory.is_dir() else ():
        ...
        target = candidate if payload.get("glyph_prior_checkpoint") else baseline
...
def _phase4_runtime_ablation_evidence() -> dict[str, Any]:
...
def build_report() -> dict:
    ...
    phases = {
        ...
        "phase4_text": [
            ...
            _row(
                "trained glyph prior changes certified delivered output",
