...
- **form-aware gradient** (068/059: 8.9/8.8 кінкаў — рампа ЦЕРАЗ форму
  лагатыпа): band-chain дэтэктар прынцыпова не бярэ (контур зліты ў
  кампанент; subchain-split адкачаны — кляіў пастэлі дыяграм 106
  iou −0.036). Правільны механізм: fit linear/radial ПОЛЕ па аб'яднанні
  ўсіх блізкіх па hue масак (без ланцугоў), acceptance тым жа рэндэрам;
  або перанесці ў хвалю В selector (gradient boundary гіпотэза).
