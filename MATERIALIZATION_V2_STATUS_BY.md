...
- Дастаўлены эфект на 100 рэальных лоцы (прагон `--out
  experiment4_m2v2_report.json` у працы на момант запісу).
...
1. **Латэнтнасць fair DP** (7 с p95 на лоцы) — блакуе прадакшн-роўт.
2. **Дастаўлены доказ** на 100 лоцы (прагон ідзе).
